...
searchCountryBtn.addEventListener('click', () => {
    ...
    clearRecords();
    axios.get(`//23.22.213.242/php-intro-connection/getRecords.php?search=${countryName}`)
        .then(response => {
...
countryBtn.addEventListener('click', () => {
    ...
    clearRecords();
    axios.get('//23.22.213.242/php-intro-connection/getRecords.php?table=country')
        .then(response => {
...
cityBtn.addEventListener('click', () => {
    ...
    clearRecords();
    axios.get('//23.22.213.242/php-intro-connection/getRecords.php?table=city')
        .then(response => {
            console.log(response.data);  // Verifica la estructura de los datos en la consola
...
countryLanguageBtn.addEventListener('click', () => {
    ...
    clearRecords();
    axios.get('//23.22.213.242/php-intro-connection/getRecords.php?table=countrylanguage')
        .then(response => {
            console.log(response.data);  // Verifica la estructura de los datos en la consola
